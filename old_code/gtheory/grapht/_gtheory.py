...
from old_code.gtheory.grapht.ncat import consensus_similarity
from old_code.gtheory.grapht.ncat import flexibility
...
def get_community_each_epoch(sbj1_path) :
  ...
  import pickle
  import numpy as np
  from old_code.gtheory.grapht import gt_leidenalg
